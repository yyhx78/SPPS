...
CURLcode docker_post(DOCKER *docker_client, const char *url, const char *data);
CURLcode docker_get(DOCKER *docker_client, const char *url);
CURLcode docker_delete(DOCKER *docker_client, const char *url);
