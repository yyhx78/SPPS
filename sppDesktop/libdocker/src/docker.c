...
CURLcode perform(DOCKER *client, const char *url) {
  init_buffer(client);
...
DOCKER *docker_init(const char *version) {
...
CURLcode docker_post(DOCKER *client, const char *url, const char *data) {
  init_curl(client);
...
CURLcode docker_get(DOCKER *client, const char *url) {
  init_curl(client);
  return perform(client, url);
}

CURLcode docker_delete(DOCKER *client, const char *url)
{
    init_curl(client);
