...
THREE.EditorControls = function ( object, domElement ) {
	...
	this.recenter = function ( newCenter ) {
	...
	this.updateCamera = function (aCamera) {
		...
		var pos = aCamera.position;
		var centerXYZ = new THREE.Vector3(0, 0, 0); //assume the center of gnome is constant

		vector.copy( pos ).sub( centerXYZ );
		...
		aCamera.position.copy( centerXYZ ).add( vector );

		aCamera.lookAt( centerXYZ );
	};
