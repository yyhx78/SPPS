...
THREE.LutInOld3JS = function ( colormap, numberofcolors ) {
...
THREE.LutInOld3JS.prototype = {

	constructor: THREE.LutInOld3JS,

	lut: [], map: [], mapname: 'rainbow', n: 256, minV: 0, maxV: 1, legend: null,

	set: function ( value ) {

		if ( value instanceof THREE.LutInOld3JS ) {
	...
	changeNumberOfColors: function ( numberofcolors ) {
		...
		return new THREE.LutInOld3JS( this.mapname, this.n );
